...
function AddTaskButton({ index, whichSectionModel, setWhichSectionMode, isTaskModelOpen, setIsTaskModelOpen, btnRef }) {
  ...
  return (
    <button
      ...
      style={{ opacity: isTaskModelOpen && whichSectionModel === index ? 0 : 1 }}
